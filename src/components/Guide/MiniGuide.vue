<template lang="pug">
.mini-guide.fixed.border-t.flex(class="md:border-t-0")
  router-link(to="/")
    svg(width="24px", height="24px", viewbox="0 0 24 24")
      g
        path(d="M4,10V21h6V15h4v6h6V10L12,3Z")
    span 首頁
  router-link.discover(to="/")
    svg(width="24px", height="24px", viewbox="0 0 24 24")
      g
        path(
...
.mini-guide {
  ...
  a {
    @apply flex-1 flex items-center flex-col;

    span {
      @apply px-1 text-main;
      font-size: 12px;
    }
