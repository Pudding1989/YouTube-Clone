...
header.flex.items-center.justify-between(class="sm:px-4")
      ...
      router-link.logo.px-3(to="/", title="YouTube 首頁")
        svg(
          ...
          g.style-scope.yt-icon(
            ...
            g.style-scope.yt-icon
              g#youtube-paths.style-scope.yt-icon
                path.style-scope.yt-icon(
  ...
  //- mobile 工具列
  .mobile-end.flex-shrink-0(class="md:hidden")
    button
      svg(
        xmlns="http://www.w3.org/2000/svg",
  ...
  //- desktop 搜尋
  .desktop-center.hidden.ml-10.flex.items-center.content-between(class="md:flex")
    .search.flex-grow.h-10.px-1.flex.items-center
      form.flex-grow.h-10.flex.items-center(class="py-0.5 px-1.5", @submit.prevent)
        svg.hidden.my-auto(
          class="mx-2.5",
          width="20px",
          height="24px",
        ...
        input.flex-grow.py-px.text-base.placeholder-secondary(
          class="focus:text-search",
          v-model="keyword",
          placeholder="搜尋"
        )
        button.close(type="button", v-if="keyword", @click="keyword = ''")
          svg(width="24px", height="24px", viewbox="0 0 24 24")
            g
              path(
                d="M12.7,12l6.6,6.6l-0.7,0.7L12,12.7l-6.6,6.6l-0.7-0.7l6.6-6.6L4.6,5.4l0.7-0.7l6.6,6.6l6.6-6.6l0.7,0.7L12.7,12z"
              )
      button.h-10.w-16.border.border-search-button.bg-search-button(
        type="submit",
        class="hover:bg-search-button-hover"
      )
  ...
  .desktop-end.hidden.flex.items-center(class="md:flex")
    ...
    router-link.flex-shrink-0.h-10.flex.items-center(to="/")
      svg(width="24px", height="24px", viewbox="0 0 24 24")
        g
          path(
      ...
      span.ml-2.text-log-in.text-sm.font-medium 登入
</template>
...
.desktop-center {
  ...
  form {
    @apply border border-r-0 border-search-box rounded-l-sm;
    box-shadow: inset 0 1px 2px #eeeeee;

    &:focus-within {
      box-shadow: inset 0 1px 2px rgba(0, 0, 0, 0.3);

      border: 1px solid #1b62b9;
...
.desktop-end {
  button {
    ...
    transition: border 0.25s ease-out, background-color 0.2s ease-out;
